...
CREATE TABLE IF NOT EXISTS `question` (
  ...
  `fauxReponse1` varchar(255) NOT NULL,
  `fauxReponse2` varchar(255) NOT NULL,
  `idNiveau` int(11) NOT NULL,
  `idCategorie` int(11) NOT NULL,
...
('def', '1101922', 'categories', 'idCategorie', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '1101922', 'categories', 'typeCategorie', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'client', 'codeClient', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '1101922', 'client', 'nomClient', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'client', 'email', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'client', 'motDePasse', 4, NULL, 'NO', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'niveau', 'idNiveau', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '1101922', 'niveau', 'nomNiveau', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'idQuestion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'question', 2, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'vraiReponse', 3, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'fauxReponse1', 4, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'fauxReponse2', 5, NULL, 'NO', 'varchar', 255, 255, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'idNiveau', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'question', 'idCategorie', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'score', 'idScore', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '1101922', 'score', 'genre', 2, NULL, 'NO', 'varchar', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
('def', '1101922', 'score', 'level', 3, NULL, 'NO', 'varchar', 11, 11, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(11)', '', '', 'select,insert,update,references', ''),
...
('ABORTED_CONNECTS', '22344'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
('BYTES_RECEIVED', '4534321054'),
('BYTES_SENT', '119399760105'),
('COM_ADMIN_COMMANDS', '179764'),
...
('COM_ALTER_SERVER', '0'),
('COM_ALTER_TABLE', '6580'),
('COM_ALTER_TABLESPACE', '0'),
('COM_ANALYZE', '163'),
('COM_BEGIN', '4799'),
('COM_BINLOG', '0'),
('COM_CALL_PROCEDURE', '0'),
('COM_CHANGE_DB', '909507'),
('COM_CHANGE_MASTER', '0'),
('COM_CHECK', '0'),
('COM_CHECKSUM', '0'),
('COM_COMMIT', '5040'),
...
('COM_SAVEPOINT', '5095'),
('COM_SELECT', '3192354'),
('COM_SET_OPTION', '2188457'),
('COM_SIGNAL', '0'),
('COM_SHOW_AUTHORS', '0'),
('COM_SHOW_BINLOG_EVENTS', '0'),
('COM_SHOW_BINLOGS', '358'),
('COM_SHOW_CHARSETS', '234'),
...
('COM_SHOW_CREATE_TABLE', '1638'),
('COM_SHOW_CREATE_TRIGGER', '0'),
('COM_SHOW_DATABASES', '832'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '0'),
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '30425'),
('COM_SHOW_FUNCTION_STATUS', '7'),
('COM_SHOW_GRANTS', '176'),
('COM_SHOW_KEYS', '1388'),
('COM_SHOW_MASTER_STATUS', '318'),
('COM_SHOW_OPEN_TABLES', '0'),
('COM_SHOW_PLUGINS', '179'),
('COM_SHOW_PRIVILEGES', '0'),
('COM_SHOW_PROCEDURE_STATUS', '7'),
('COM_SHOW_PROCESSLIST', '9755'),
('COM_SHOW_PROFILE', '4'),
('COM_SHOW_PROFILES', '1'),
('COM_SHOW_RELAYLOG_EVENTS', '0'),
('COM_SHOW_SLAVE_HOSTS', '0'),
('COM_SHOW_SLAVE_STATUS', '318'),
('COM_SHOW_STATUS', '145'),
('COM_SHOW_STORAGE_ENGINES', '135'),
('COM_SHOW_TABLE_STATUS', '3516'),
('COM_SHOW_TABLES', '15005'),
('COM_SHOW_TRIGGERS', '85'),
('COM_SHOW_VARIABLES', '2636'),
('COM_SHOW_WARNINGS', '122'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '66177'),
('COM_STMT_EXECUTE', '67375'),
('COM_STMT_FETCH', '0'),
('COM_STMT_PREPARE', '67342'),
('COM_STMT_REPREPARE', '0'),
('COM_STMT_RESET', '18611'),
('COM_STMT_SEND_LONG_DATA', '0'),
('COM_TRUNCATE', '610'),
('COM_UNINSTALL_PLUGIN', '0'),
('COM_UNLOCK_TABLES', '503'),
('COM_UPDATE', '786448'),
('COM_UPDATE_MULTI', '306'),
('COM_XA_COMMIT', '0'),
('COM_XA_END', '0'),
('COM_XA_PREPARE', '0'),
('COM_XA_RECOVER', '0'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '1562152'),
('CREATED_TMP_DISK_TABLES', '141782'),
('CREATED_TMP_FILES', '1723'),
('CREATED_TMP_TABLES', '307565'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '161'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '1167334'),
('HANDLER_DELETE', '138987'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '559072'),
('HANDLER_READ_KEY', '119615044'),
('HANDLER_READ_LAST', '16780'),
('HANDLER_READ_NEXT', '1316044876'),
('HANDLER_READ_PREV', '21169519'),
('HANDLER_READ_RND', '154942841'),
('HANDLER_READ_RND_NEXT', '1985930195'),
('HANDLER_ROLLBACK', '607'),
('HANDLER_SAVEPOINT', '5063'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '29817308'),
('HANDLER_WRITE', '46807815'),
('INNODB_BUFFER_POOL_PAGES_DATA', '32053'),
('INNODB_BUFFER_POOL_BYTES_DATA', '525156352'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '374311'),
('INNODB_BUFFER_POOL_PAGES_FREE', '0'),
('INNODB_BUFFER_POOL_PAGES_MISC', '714'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '32767'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '5799'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '1074'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '265785365'),
('INNODB_BUFFER_POOL_READS', '152661'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2950361'),
('INNODB_DATA_FSYNCS', '269188'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '2602848256'),
('INNODB_DATA_READS', '165476'),
('INNODB_DATA_WRITES', '624379'),
('INNODB_DATA_WRITTEN', '14074234880'),
('INNODB_DBLWR_PAGES_WRITTEN', '374311'),
('INNODB_DBLWR_WRITES', '9507'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '3358395'),
('INNODB_LOG_WRITES', '230866'),
('INNODB_OS_LOG_FSYNCS', '235995'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '1807824896'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '8596'),
('INNODB_PAGES_READ', '158731'),
('INNODB_PAGES_WRITTEN', '374311'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '5923'),
('INNODB_ROW_LOCK_TIME_AVG', '20'),
('INNODB_ROW_LOCK_TIME_MAX', '264'),
('INNODB_ROW_LOCK_WAITS', '284'),
('INNODB_ROWS_DELETED', '43507'),
('INNODB_ROWS_INSERTED', '134896'),
('INNODB_ROWS_READ', '301574466'),
('INNODB_ROWS_UPDATED', '286141'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '180392'),
('KEY_BLOCKS_USED', '145153'),
('KEY_READ_REQUESTS', '286089312'),
('KEY_READS', '940613'),
('KEY_WRITE_REQUESTS', '2530577'),
('KEY_WRITES', '887352'),
...
('OPEN_FILES', '21700'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '11811'),
('OPEN_TABLES', '12288'),
('OPENED_FILES', '1136001'),
('OPENED_TABLE_DEFINITIONS', '190247'),
('OPENED_TABLES', '196582'),
...
('QCACHE_FREE_BLOCKS', '19472'),
('QCACHE_FREE_MEMORY', '44623096'),
('QCACHE_HITS', '15910473'),
('QCACHE_INSERTS', '2959358'),
('QCACHE_LOWMEM_PRUNES', '1145029'),
('QCACHE_NOT_CACHED', '232279'),
('QCACHE_QUERIES_IN_CACHE', '51868'),
('QCACHE_TOTAL_BLOCKS', '169671'),
('QUERIES', '25189299'),
('QUESTIONS', '25037179'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '9086'),
('SELECT_FULL_RANGE_JOIN', '1342'),
('SELECT_RANGE', '264328'),
('SELECT_RANGE_CHECK', '7249'),
('SELECT_SCAN', '472557'),
...
('SSL_VERIFY_MODE', '0'),
('SSL_VERSION', ''),
('TABLE_LOCKS_IMMEDIATE', '5238500'),
('TABLE_LOCKS_WAITED', '752'),
('TC_LOG_MAX_PAGES_USED', '0'),
('TC_LOG_PAGE_SIZE', '0'),
('TC_LOG_PAGE_WAITS', '0'),
('THREADS_CACHED', '5'),
('THREADS_CONNECTED', '4'),
('THREADS_CREATED', '15129'),
('THREADS_RUNNING', '1'),
('UPTIME', '51913'),
...
('def', '1101922', 'PRIMARY', 'def', '1101922', 'client', 'codeClient', 1, NULL, NULL, NULL, NULL),
('def', '1101922', 'PRIMARY', 'def', '1101922', 'niveau', 'idNiveau', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 66819522, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 65431080, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 67028580, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 66297000, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 67032080, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 67064931, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 66248336, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 67078276, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 66952192, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 66954133, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 67026680, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 67022450, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 67057200, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 67098003, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 66894360, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 66994768, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 66906354, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2016-02-19 12:54:21', '2016-02-19 12:54:21', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 67067376, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 67075996, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 65329400, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 66996952, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 60817408, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 52428800, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 67080868, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 60817408, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 52428800, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 67076802, 0, 0, '2016-02-19 12:54:21', NULL, NULL, NULL, '', '', NULL),
('def', '1101922', 'categories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 22, 88, 281474976710655, 2048, 0, '2016-02-18 17:55:43', '2016-02-18 17:55:43', NULL, NULL, '', '', NULL),
('def', '1101922', 'client', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14, 1170, 16384, NULL, 0, 0, '2016-02-18 17:55:44', NULL, NULL, NULL, '', '', NULL),
('def', '1101922', 'niveau', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 20, 60, 281474976710655, 2048, 0, '2016-02-18 17:55:43', '2016-02-18 17:55:43', NULL, NULL, '', '', NULL),
...
('''1101922''@''localhost''', 'def', '1101922', 'INSERT', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'UPDATE', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'DELETE', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'CREATE', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'DROP', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'REFERENCES', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'INDEX', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'ALTER', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'CREATE TEMPORARY TABLES', 'NO'),
('''1101922''@''localhost''', 'def', '1101922', 'LOCK TABLES', 'NO'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '5799'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '1074'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '265785426'),
('INNODB_BUFFER_POOL_READS', '152661'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2950361'),
('INNODB_DATA_FSYNCS', '269188'),
...
('INNODB_ROWS_DELETED', '43507'),
('INNODB_ROWS_INSERTED', '134896'),
('INNODB_ROWS_READ', '301574474'),
('INNODB_ROWS_UPDATED', '286141'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '180325'),
('KEY_BLOCKS_USED', '145153'),
('KEY_READ_REQUESTS', '286101403'),
('KEY_READS', '940679'),
('KEY_WRITE_REQUESTS', '2530615'),
('KEY_WRITES', '887382'),
...
('PERFORMANCE_SCHEMA_THREAD_INSTANCES_LOST', '0'),
('PREPARED_STMT_COUNT', '0'),
('QCACHE_FREE_BLOCKS', '19484'),
('QCACHE_FREE_MEMORY', '44608912'),
('QCACHE_HITS', '15911482'),
('QCACHE_INSERTS', '2959595'),
('QCACHE_LOWMEM_PRUNES', '1145168'),
('QCACHE_NOT_CACHED', '232306'),
('QCACHE_QUERIES_IN_CACHE', '51822'),
('QCACHE_TOTAL_BLOCKS', '169607'),
('QUERIES', '25190862'),
('QUESTIONS', '171'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '0'),
...
('def', '1101922', 'categories', 0, '1101922', 'PRIMARY', 1, 'idCategorie', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', '1101922', 'client', 0, '1101922', 'PRIMARY', 1, 'codeClient', 'A', 14, NULL, NULL, '', 'BTREE', '', ''),
('def', '1101922', 'niveau', 0, '1101922', 'PRIMARY', 1, 'idNiveau', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', '1101922', 'question', 0, '1101922', 'PRIMARY', 1, 'idQuestion', 'A', 48, NULL, NULL, '', 'BTREE', '', ''),
('def', '1101922', 'score', 0, '1101922', 'PRIMARY', 1, 'idScore', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
('def', '1101922', 'score', 1, '1101922', 'idJoueur', 1, 'nomJoueur', 'A', NULL, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 65739264, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=174762', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 66819522, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=290514', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 65431080, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=344148', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=11210', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 67028580, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=26163', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 66297000, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=136956', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=2475', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 67032080, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=25068', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 67064931, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=14472', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=24200', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=22317', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=45313', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=95596', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 66248336, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=217885', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 67078276, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=13940', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=2334', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 66952192, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=19373', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 66954133, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=30798', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 67026680, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=20535', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 67022450, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=11665', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 67057200, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7101', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 67098003, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=9654', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 66894360, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=26800', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 66994768, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28292', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=2277', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 66906354, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=33790', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2016-02-19 12:54:26', '2016-02-19 12:54:26', NULL, 'utf8_general_ci', NULL, 'max_rows=27742', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 67067376, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=9794', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 67075996, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=14801', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 65329400, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=261123', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 66996952, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=112034', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 60817408, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2314098', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 52428800, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2684354', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 67080868, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2147', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 60817408, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2314098', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 52428800, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2684354', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 67076802, 0, 0, NULL, '2016-02-19 12:54:26', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=10062', ''),
('def', '1101922', 'categories', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 22, 88, 281474976710655, 2048, 0, NULL, '2016-02-18 17:55:43', '2016-02-18 17:55:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '1101922', 'client', 'BASE TABLE', 'InnoDB', 10, 'Compact', 14, 1170, 16384, 0, 0, 0, 41, '2016-02-18 17:55:44', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '1101922', 'niveau', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 20, 60, 281474976710655, 2048, 0, NULL, '2016-02-18 17:55:43', '2016-02-18 17:55:43', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '1101922', 'question', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 48, 97, 4692, 281474976710655, 2048, 0, 49, '2016-02-18 17:55:44', '2016-02-19 12:35:35', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '1101922', 'score', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 39, 276, 281474976710655, 3072, 0, 8, '2016-02-19 12:28:31', '2016-02-19 12:42:56', NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', '1101922', 'PRIMARY', '1101922', 'categories', 'PRIMARY KEY'),
('def', '1101922', 'PRIMARY', '1101922', 'client', 'PRIMARY KEY'),
('def', '1101922', 'PRIMARY', '1101922', 'niveau', 'PRIMARY KEY'),
('def', '1101922', 'PRIMARY', '1101922', 'question', 'PRIMARY KEY'),
('def', '1101922', 'PRIMARY', '1101922', 'score', 'PRIMARY KEY');
...
('''1101922''@''localhost''', 'def', 'USAGE', 'NO');
...
-- Erreur de lecture des données :  (#1227 - Access denied; you need (at least one of) the PROCESS privilege(s) for this operation)
